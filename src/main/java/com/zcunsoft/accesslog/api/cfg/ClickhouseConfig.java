...
import com.zcunsoft.accesslog.api.repository.BaseRepositoryImpl;
...
@Configuration
@EntityScan(basePackages = "com.zcunsoft.accesslog.api.entity.clickhouse")
@EnableJpaRepositories(
        basePackages = "com.zcunsoft.accesslog.api.repository.clickhouse",
...
public class ClickhouseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean clickhouseEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.zcunsoft.accesslog.report.entity.clickhouse")
